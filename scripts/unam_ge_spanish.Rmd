---
title: "La brecha salarial de género del profesorado de la UNAM"
...
Todos los datos salariales de la UNAM están [disponibles al público](http://www.transparencia.unam.mx/obligaciones/consulta/remuneracion-profesores). Descargué estos datos y los guardé como un archivo separado por tabuladores. Hice algunos cambios al archivo para eliminar caracteres que no son ASCII y para renombrar las columnas con nombres más bonitos.
